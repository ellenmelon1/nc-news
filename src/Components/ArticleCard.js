const ArticleCard = ({ title, topic, author, votes }) => {
  return (
    <article className="articleCards pv4 bt bb b--black-10 ph3 ph0-l">
      <div className="flex flex-column flex-row-ns w-100 w-60-ns pr3-ns order-2 order-1-ns">
        ...
        <p className="f6 lh-copy gray mv0">Share</p>
